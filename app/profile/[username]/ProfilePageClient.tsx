            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                {!currentUser ? (
                  ...
                  <Button className="mt-4 w-full" onClick={() => setShowEditDialog(true)}>
          ...
          <TabsContent value="posts" className="mt-6">
            <div className="space-y-6">
              {posts.length > 0 ? (
                ...
                <div className="text-muted-foreground py-8 text-center">No posts yet</div>
              )}
            </div>
          </TabsContent>
          ...
          <TabsContent value="likes" className="mt-6">
            <div className="space-y-6">
              {likedPosts.length > 0 ? (
                ...
                <div className="text-muted-foreground py-8 text-center">No liked posts to show</div>
              )}
            </div>
          </TabsContent>
        </Tabs>
